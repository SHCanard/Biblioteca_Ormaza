    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de biblioteca <small>Listar Libros</small></h1>
            </div>
        </div>
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              <li role="presentation" class="active"><a href="nuevo_libro.php">Nuevo libro</a></li>
              <li role="presentation"><a href="listar_libros.php">Listar Libros</a></li>
            </ul>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de los libros. Puede actualizar o eliminar los datos tanto como sea necesario.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li><a href="informe_libro.php">Generar Informe</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $fila["nombre_categoria_libro"];?></td>
                    <td><?php echo $fila["autor_libro"];?></td>
                    <td><?php echo $fila["editorial_libro"];?></td>
                    <td><?php echo $fila["isbn_libro"];?></td>
                    <td><a href="editar_libro.php?id=<?php echo $fila["id"];?>"><img src='../assets/img/editar.png' width=30 height=30></a></td>
                    <td><a href="eliminar_libro.php?id=<?php echo $fila["id"];?>"><img src='../assets/img/eliminar.png' width=30 height=30></a></td>
                    <?php }?>
                </tr>
            </tbody>
        </table>
