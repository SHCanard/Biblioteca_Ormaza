...
<?php
	...
	$pdf->SetX(65);
	$pdf->Cell(95,6,'CATEGORIA',1,0,'C',1);
	$pdf->SetX(160);
	...
	while ($fila = $res->fetch_assoc())
	{
		...
		$pdf->SetX(15);
		$pdf->Cell(50,6,utf8_decode($fila['titulo_libro']),1,0,'C');
		$pdf->SetX(65);
		$pdf->Cell(95,6,utf8_decode($fila['nombre_categoria_libro']),1,0,'C');
		$pdf->SetX(160);
		$pdf->Cell(50,6,utf8_decode($fila['autor_libro']),1,0,'C');
		$pdf->SetX(210);
		$pdf->Cell(40,6,utf8_decode($fila['editorial_libro']),1,0,'C');
		$pdf->SetX(250);
		$pdf->Cell(40,6,utf8_decode($fila['isbn_libro']),1,1,'C');
	}
