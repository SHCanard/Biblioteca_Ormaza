    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de Biblioteca <small>Editar Libro</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para editar libros de la biblioteca, debe diligenciar el siguiente formulario para poder modificar el libro.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form autocomplete="off" method="POST" action="actualizar_libro.php">
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <br><br>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escriba aquí el título del libro" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Título del libro" name="titulo_libro" value="<?php echo $fila["titulo_libro"]; ?>">
                            ...
                            <div class="group-material">
                                ...
                                include ("../db/conexion.php");
                                    ...
                                    $result = $conexion->query($sql); //usamos la conexion para dar un resultado a la variable
                                        ...
                                        ?>
                                        <select name="nombre_categoria_libro" class="material-control tooltips-general" required="" maxlength="11" data-toggle="tooltip" data-placement="top" title="Seleccione la categoría del libro" value="<?php echo $fila["nombre_categoria_libro"]; ?>">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                            <?php echo $combobit; ?>
                                        </select>
                            ...
                            <!--<div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escriba aquí la categoría del libro" required="" data-toggle="tooltip" data-placement="top" title="Categoría del libro" name="nombre_categoria_libro" value="<?php /*echo $fila["nombre_categoria_libro"];*/ ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escriba aquí el autor del libro" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Autor del libro" name="autor_libro" value="<?php echo $fila["autor_libro"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Autor</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escriba aquí la editorial del libro" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Editorial del libro" name="editorial_libro" value="<?php echo $fila["editorial_libro"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Editorial</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escriba aquí el ISBN del libro" required="" maxlength="30" data-toggle="tooltip" data-placement="top" title="ISBN del libro" name="isbn_libro" value="<?php echo $fila["isbn_libro"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>ISBN</label>
                            </div>
                            <p class="text-center">
                                ...
                                <button type="submit" class="btn btn-primary" name="btn12"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Guardar</button>
                            </p> 
                       </div>
                    </div>
                </form>
