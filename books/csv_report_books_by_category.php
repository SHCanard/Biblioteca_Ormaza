...
$mostrar = 
                    "
                        SELECT title_books,summary_books,internet_link_books,tags_books,name_categories,name_mediums,author_books,editor_books,isbn_books,inventory_number_books,CASE is_loaned_books WHEN TRUE THEN 'Oui' ELSE 'Non' END AS is_loaned_books FROM books,categories,mediums WHERE id_categories=id_category_books AND id_mediums=id_medium_books AND id_categories=".$cat.";
                    ";
