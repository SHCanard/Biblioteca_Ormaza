...
$mostrar = 
                    "
                        SELECT title_books,inventory_number_books,first_name,last_name,date_loans,date_expired_loans,date_return_loans,state_loans FROM loans JOIN users ON id=code_user_loans JOIN books ON id_book_loans=id_books ORDER BY date_loans desc, state_loans;
                    ";
