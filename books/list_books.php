...
<head>
    <title><?php echo $language['book_list']; ?></title>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles"><?php echo $language['system_title']; ?> <small><?php echo $language['book_list']; ?></small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid">
			<h2 class="text-center all-tittles"><i class="zmdi zmdi-collection-item zmdi-hc-fw"></i> <?php echo $language['book_list']; ?></h2>
        </div>
        <div class="container-fluid">
            <?php if(isset($_SESSION['usertype']) AND $_SESSION['usertype']==1)
			echo '<div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li>~ <a href="csv_report_books.php">'.$language['csv_generate'].'</a></li>
                    </ol>
                </div>
            </div>'; ?>
            <?php
                   include ("../db/conexion.php");
                    ...
                    $mostrar = 
                    "
                        SELECT * FROM books,categories,mediums WHERE id_categories=id_category_books AND id_mediums=id_medium_books;
                    ";
