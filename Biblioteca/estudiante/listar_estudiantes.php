                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="../prestamos/listar_prestamos.php"><i class="zmdi zmdi-bookmark-outline zmdi-hc-fw"></i>&nbsp;&nbsp; Listar Préstamos </a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de biblioteca <small>Listar Estudiantes</small></h1>
            </div>
        </div>
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
              <li role="presentation" class="active"><a href="nuevo_estudiante.php">Nuevo Estudiante</a></li>
              <li role="presentation"><a href="listar_estudiantes.php">Listar Estudiantes</a></li>
            </ul>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de los estudiantes. Puede actualizar o eliminar los datos de los estudiantes tanto como sea necesario.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li><a href="informe_estudiante.php">Generar Informe</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $fila["doc_identidad_estudiante"];?></td>
                    <td><?php echo $fila["nombre_estudiante"];?></td>
                    <td><?php echo $fila["apellido_estudiante"];?></td>
                    <td><?php echo $fila["telefono_estudiante"];?></td>
                    <td><?php echo $fila["direccion_estudiante"];?></td>
                    <td><a href="editar_estudiante.php?id=<?php echo $fila["id"];?>"><img src='../assets/img/editar.png' width=30 height=30></a></td>
                    <td><a href="eliminar_estudiante.php?id=<?php echo $fila["id"];?>"><img src='../assets/img/eliminar.png' width=30 height=30></a></td>
                    <?php }?>
                </tr>
            </tbody>
        </table>
