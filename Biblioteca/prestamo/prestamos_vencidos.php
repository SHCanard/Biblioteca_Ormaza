    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de biblioteca <small>préstamos vencidos</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="../assets/img/alerta.png" alt="user" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de los Préstamos Vencidos.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li><a href="informe_prestamos_vencidos.php">Generar Informe</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <h2 class="text-center all-tittles">préstamos vencidos</h2>
            <br>
            <?php
                   ...
                   include ("../db/conexion.php");
                    ...
                    $mostrar = 
                    "
                        SELECT * FROM prestamo where fecha_vencimiento < NOW() AND estado_prestamo='Pendiente';
                    ";
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $fila["nombre_libro_prestamo"];?></td>
                    <td><?php echo $fila["doc_ident_estud_prestamo"];?></td>
                    <td><?php echo $fila["fecha_prestamo"];?></td>
                    <td><?php echo $fila["fecha_vencimiento"];?></td>
                    <td><?php echo $fila["estado_prestamo"];?></td>
                    <td><a href="entregar_prestamo.php?id=<?php echo $fila["id"];?>"><img src='../assets/img/entrega.png' width=30 height=30></a></td>
                    <?php }?>
                </tr>
            </tbody>
        </table>
