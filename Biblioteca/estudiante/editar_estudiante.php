    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de Biblioteca <small>Editar Estudiante</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para editar estudiantes registrados, para poder editar un estudiante debe diligenciar el siguiente formulario.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form autocomplete="off" method="POST" action="actualizar_estudiante.php">
                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <br><br>
                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" placeholder="Escriba aquí el documento del estudiante" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Documento del estudiante" name="doc_identidad_estudiante" value="<?php echo $fila["doc_identidad_estudiante"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Documento de Identidad</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escriba aquí los nombres del estudiante" required="" maxlength="30" data-toggle="tooltip" data-placement="top" title="Nombres del estudiante" name="nombre_estudiante" value="<?php echo $fila["nombre_estudiante"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nombres</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escriba aquí los apellidos del estudiante" required="" maxlength="30" data-toggle="tooltip" data-placement="top" title="Apellidos del estudiante" name="apellido_estudiante" value="<?php echo $fila["apellido_estudiante"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Apellidos</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Teléfono" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Teléfono del estudiante" name="telefono_estudiante" value="<?php echo $fila["telefono_estudiante"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Teléfono</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Dirección" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Dirección del estudiante" name="direccion_estudiante" value="<?php echo $fila["direccion_estudiante"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <p class="text-center">
                                ...
                                <button type="submit" name="btn10" class="btn btn-primary"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Guardar</button>
                            </p> 
                       </div>
                    </div>
                </form>
