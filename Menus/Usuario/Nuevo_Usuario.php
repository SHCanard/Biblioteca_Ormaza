            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="nuevo_estudiante.php"><i class="zmdi zmdi-face zmdi-hc-fw"></i>&nbsp;&nbsp; Nuevo Estudiante</a></li>
                            <li><a href="listar_estudiantes.php"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i>&nbsp;&nbsp; Listar Estudiantes</a></li>
                        </ul>
                    </li>
                    <li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de Biblioteca <small>Añadir Estudiante</small></h1>
            </div>
        </div>
        <div class="conteiner-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"><a href="nuevo_estudiante.php">Nuevo Estudiante</a></li>
                <li role="presentation" class="active"><a href="listar_estudiantes.php">Listar Estudiantes</a></li>
            </ul>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar nuevos estudiantes, para poder registrar un estudiante debe diligenciar el siguiente formulario.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form autocomplete="off" method="POST" action="Registrar_Usuario.php">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           <legend>Datos del usuario</legend>
                           <br><br>
                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" placeholder="Escriba aquí el Codigo del usuario" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Documento del usuario" name="Codigo">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Documento de Identidad</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escriba aquí los nombres del usuario" required="" maxlength="30" data-toggle="tooltip" data-placement="top" title="Nombres del usuario" name="Nombre">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nombres</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escriba aquí los apellidos del usuario" required="" maxlength="30" data-toggle="tooltip" data-placement="top" title="Apellidos del usuario" name="Apellidos">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Apellidos</label>
                            </div>
                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Teléfono del usuario" name="Telefono">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Teléfono</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Dirección" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Dirección del usuario" name="Direccion">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Dirección</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Email" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Email del usuario" name="Email">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Email</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Contraseña" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Contraseña" name="Contrasena">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Contraseña</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Fecha de nacimiento" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Fecha de nacimiento" name="Fecha_Nacimiento">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Fecha_Nacimiento</label>
                            </div>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Tipo_Usuario" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Tipo de usuario" name="Tipo_Usuario">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <p class="text-center">
                                ...
                                <button type="submit" name="btn9" class="btn btn-primary"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Guardar</button>
                            </p> 
                       </div>
                    </div>
                </form>
