    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de Biblioteca <small>Editar Préstamo</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para editar préstamos de libros, modifique los campos que considere necesarios en el siguiente formulario.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Editar préstamo</div>
                <form autocomplete="off" method="POST" action="actualizar_prestamo.php">
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <br><br>
                                ...
                                include ("../db/conexion.php");
                                    ...
                                    $result = $conexion->query($sql); //usamos la conexion para dar un resultado a la variable
                                        ...
                                        if ($result->num_rows > 0) //si la variable tiene al menos 1 fila entonces seguimos con el codigo
                                        {
                                            ...
                                            while ($row = $result->fetch_array(MYSQLI_ASSOC)) 
                                            {
                                                $combobit .=" <option value='".$row['doc_identidad_estudiante']."'>".$row['doc_identidad_estudiante']."</option>"; //concatenamos el los options para luego ser insertado en el HTML
                                            }
                                        }
                                        else
                                        {
                            ...
                            <div class="group-material">
                                <input type="date" class="material-control tooltips-general" required="" data-toggle="tooltip" data-placement="top" title="Fecha de préstamo" name="fecha_prestamo" value="<?php echo $fila["fecha_prestamo"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Fecha de Préstamo</label>
                            </div>
                            <div class="group-material">
                                <input type="date" class="material-control tooltips-general" required="" data-toggle="tooltip" data-placement="top" title="Fecha de vencimiento" name="fecha_vencimiento" value="<?php echo $fila["fecha_vencimiento"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Fecha de Vencimiento</label>
                            </div>
                            <div class="group-material">
                                <input type="date" class="material-control tooltips-general" data-toggle="tooltip" data-placement="top" title="Fecha de devolución" name="fecha_devolucion" value="<?php echo $fila["fecha_devolucion"]; ?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <select name="estado_prestamo" class="material-control tooltips-general" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Estado del Préstamo">
                                    <option value="" disabled="" selected=""><?php echo $fila["estado_prestamo"]; ?></option>
                            ...
                            <p class="text-center">
                                ...
                                <button type="submit" class="btn btn-primary" name="btn14"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Guardar</button>
                            </p> 
                       </div>
                    </div>
                </form>
