        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de los préstamos. Puede actualizar o eliminar los datos tanto como sea necesario.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li><a href="informe_prestamo.php">Generar Informe</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <h2 class="text-center all-tittles">lista de préstamos</h2>
            <br>
            <?php
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="editar_prestamo.php?id=<?php echo $fila["id"];?>"><img src='../assets/img/editar.png' width=30 height=30></a></td>
                    <td><a href="eliminar_prestamo.php?id=<?php echo $fila["id"];?>"><img src='../assets/img/eliminar.png' width=30 height=30></a></td>
                    <?php }?>
                </tr>
            </tbody>
        </table>
